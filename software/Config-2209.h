...
#define AXIS1_DRIVER_IRUN             OFF //    OFF, n, (mA.) 跟踪时的电流根据电机/驱动调整                       Option
#define AXIS1_DRIVER_IGOTO            OFF //    OFF, n, (mA.) GOTO时的电流OFF 代表和 IRUN 一样.                  Option
#define AXIS1_DRIVER_REVERSE           ON //    OFF, ON 反转运动方向或者你也可以把电机线反着接.                   <-Often
